...
BEGIN_MESSAGE_MAP(CSceneLightDialog, CDialog)
	...
	ON_BN_CLICKED(IDC_CHANNEL_BOTH_RADIO, &ThisClass::OnChannelBothRadio)
	ON_BN_CLICKED(IDC_CHANNEL_DIFFUSE_RADIO, &ThisClass::OnChannelDiffuseRadio)
	ON_BN_CLICKED(IDC_CHANNEL_SPECULAR_RADIO, &ThisClass::OnChannelSpecularRadio)
	ON_BN_CLICKED(IDC_ATTENUATION_CHECK, &ThisClass::OnAttenuationCheck)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
