...
BEGIN_MESSAGE_MAP(ColorSelectionDialogClass, CDialog)
	...
	ON_EN_CHANGE(IDC_BLUE_EDIT, &ThisClass::OnChangeBlueEdit)
	ON_EN_CHANGE(IDC_GREEN_EDIT, &ThisClass::OnChangeGreenEdit)
	ON_EN_CHANGE(IDC_RED_EDIT, &ThisClass::OnChangeRedEdit)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
