...
BEGIN_MESSAGE_MAP(CAnimationSpeed, CDialog)
	...
	ON_WM_HSCROLL()
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BLEND, &ThisClass::OnBlend)
	ON_BN_CLICKED(IDC_COMPRESSQ, &ThisClass::OnCompressq)
	ON_BN_CLICKED(IDC_16BIT, &ThisClass::On16bit)
	ON_BN_CLICKED(IDC_8BIT, &ThisClass::On8bit)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
