...
BEGIN_MESSAGE_MAP(TeamGeneric, CPropertyPage)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script1, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script2, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script3, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script4, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script5, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script6, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script7, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script8, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script9, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script10, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script11, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script12, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script13, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script14, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script15, &ThisClass::OnScriptAdjust)
	ON_CBN_SELCHANGE(IDC_TeamGeneric_Script16, &ThisClass::OnScriptAdjust)
END_MESSAGE_MAP()