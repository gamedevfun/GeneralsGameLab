...
BEGIN_MESSAGE_MAP(WbView3d, WbView)
	...
	ON_COMMAND(ID_LOOK_EAST, &ThisClass::OnLookEast)
	ON_UPDATE_COMMAND_UI(ID_LOOK_EAST, &ThisClass::OnUpdateLookEast)
	ON_COMMAND(ID_LOOK_NORTH, &ThisClass::OnLookNorth)
	ON_UPDATE_COMMAND_UI(ID_LOOK_NORTH, &ThisClass::OnUpdateLookNorth)
	ON_COMMAND(ID_LOOK_SOUTH, &ThisClass::OnLookSouth)
	ON_UPDATE_COMMAND_UI(ID_LOOK_SOUTH, &ThisClass::OnUpdateLookSouth)
	ON_COMMAND(ID_LOOK_WEST, &ThisClass::OnLookWest)
	ON_UPDATE_COMMAND_UI(ID_LOOK_WEST, &ThisClass::OnUpdateLookWest)
