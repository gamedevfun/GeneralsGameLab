...
BEGIN_MESSAGE_MAP(CWB3dFrameWnd, CMainFrame)
	...
	ON_WM_MOVE()
	ON_COMMAND(ID_WINDOW_PREVIEW1024X768, &ThisClass::OnWindowPreview1024x768)
	ON_UPDATE_COMMAND_UI(ID_WINDOW_PREVIEW1024X768, &ThisClass::OnUpdateWindowPreview1024x768)
	ON_COMMAND(ID_WINDOW_PREVIEW640X480, &ThisClass::OnWindowPreview640x480)
	ON_UPDATE_COMMAND_UI(ID_WINDOW_PREVIEW640X480, &ThisClass::OnUpdateWindowPreview640x480)
	ON_COMMAND(ID_WINDOW_PREVIEW800X600, &ThisClass::OnWindowPreview800x600)
	ON_UPDATE_COMMAND_UI(ID_WINDOW_PREVIEW800X600, &ThisClass::OnUpdateWindowPreview800x600)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
