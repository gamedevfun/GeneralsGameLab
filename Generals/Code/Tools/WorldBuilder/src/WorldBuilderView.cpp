...
BEGIN_MESSAGE_MAP(CWorldBuilderView, WbView)
	...
	ON_WM_VSCROLL()
	ON_WM_HSCROLL()
	ON_COMMAND(IDM_ShowGrid, &ThisClass::OnShowGrid)
	ON_UPDATE_COMMAND_UI(IDM_ShowGrid, &ThisClass::OnUpdateShowGrid)
	ON_WM_CREATE()
	ON_COMMAND(ID_VIEW_SHOWTEXTURE, &ThisClass::OnViewShowtexture)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWTEXTURE, &ThisClass::OnUpdateViewShowtexture)
