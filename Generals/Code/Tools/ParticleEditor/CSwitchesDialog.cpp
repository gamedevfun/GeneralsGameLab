...
BEGIN_MESSAGE_MAP(CSwitchesDialog, CDialog)
	ON_BN_CLICKED(IDC_PSEd_OneShot, &ThisClass::OnParticleSystemEdit)
	ON_BN_CLICKED(IDC_PSEd_Hollow, &ThisClass::OnParticleSystemEdit)
	ON_BN_CLICKED(IDC_PSEd_GroundAligned, &ThisClass::OnParticleSystemEdit)
	ON_BN_CLICKED(IDC_PSEd_EmitAboveGroundOnly, &ThisClass::OnParticleSystemEdit)
	ON_BN_CLICKED(IDC_PSEd_ParticleUpTowardsEmitter, &ThisClass::OnParticleSystemEdit)
END_MESSAGE_MAP()
