...
BEGIN_MESSAGE_MAP(MoreParmsDialog, CDialog)
	ON_EN_KILLFOCUS(IDC_PSEd_InitialDelayMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_InitialDelayMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_BurstDelayMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_BurstDelayMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_BurstCountMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_BurstCountMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_ColorScaleMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_ColorScaleMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_ParticleLifetimeMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_ParticleLifetimeMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_StartSizeRateMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_StartSizeRateMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeRateMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeRateMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeDampingMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SizeDampingMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SystemLifetime, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SlaveOffsetX, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SlaveOffsetY, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_SlaveOffsetZ, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_DriftVelocityX, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_DriftVelocityY, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_DriftVelocityZ, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_SlaveSystem, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_PerParticleSystem, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindAngleChangeMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindAngleChangeMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindPingPongStartAngleMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindPingPongStartAngleMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindPingPongEndAngleMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_WindPingPongEndAngleMax, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_WindMotion, &ThisClass::OnParticleSystemEdit)
END_MESSAGE_MAP()
