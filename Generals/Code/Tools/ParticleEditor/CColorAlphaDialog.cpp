...
BEGIN_MESSAGE_MAP(CColorAlphaDialog, CDialog)
	ON_BN_CLICKED(IDC_PSEd_Color1, &ThisClass::OnColor1)
	ON_BN_CLICKED(IDC_PSEd_Color2, &ThisClass::OnColor2)
	ON_BN_CLICKED(IDC_PSEd_Color3, &ThisClass::OnColor3)
	ON_BN_CLICKED(IDC_PSEd_Color4, &ThisClass::OnColor4)
	ON_BN_CLICKED(IDC_PSEd_Color5, &ThisClass::OnColor5)
	ON_BN_CLICKED(IDC_PSEd_Color6, &ThisClass::OnColor6)
	ON_BN_CLICKED(IDC_PSEd_Color7, &ThisClass::OnColor7)
	ON_BN_CLICKED(IDC_PSEd_Color8, &ThisClass::OnColor8)

	ON_EN_KILLFOCUS(IDC_PSEd_CF1_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF2_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF3_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF4_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF5_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF6_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF7_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_CF8_Frame, &ThisClass::OnParticleSystemEdit)

	ON_EN_KILLFOCUS(IDC_PSEd_AF1_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF2_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF3_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF4_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF5_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF6_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF7_Min, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF8_Min, &ThisClass::OnParticleSystemEdit)

	ON_EN_KILLFOCUS(IDC_PSEd_AF1_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF2_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF3_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF4_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF5_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF6_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF7_Max, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF8_Max, &ThisClass::OnParticleSystemEdit)

	ON_EN_KILLFOCUS(IDC_PSEd_AF1_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF2_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF3_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF4_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF5_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF6_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF7_Frame, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AF8_Frame, &ThisClass::OnParticleSystemEdit)
END_MESSAGE_MAP()
