...
BEGIN_MESSAGE_MAP(DebugWindowDialog, CDialog)
	...
	ON_WM_SIZE()
	ON_WM_SYSCOMMAND()
	ON_CBN_SELCHANGE(IDC_PSEd_ParticleSystem, &ThisClass::OnParticleSystemChange)
	ON_BN_CLICKED(IDC_PSEd_Go, &ThisClass::OnParticleSystemChange)
	ON_BN_CLICKED(IDC_PSEd_EditColorButton, &ThisClass::OnEditColorAlpha)
	ON_BN_CLICKED(IDC_PSEd_Continued, &ThisClass::OnEditMoreParms)
	ON_BN_CLICKED(IDC_PSEd_Save, &ThisClass::OnPushSave)
	ON_BN_CLICKED(IDC_PSEd_EditSwitchesButton, &ThisClass::OnEditSwitches)
	ON_BN_CLICKED(IDC_PSEd_KillAll, &ThisClass::OnKillAllParticleSystems)

	ON_CBN_SELCHANGE(IDC_PSEd_Priority, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_EmissionType, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_VelocityType, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_ParticleType, &ThisClass::OnParticleSystemEdit)
	ON_CBN_SELCHANGE(IDC_PSEd_ShaderType, &ThisClass::OnParticleSystemEdit)
	ON_COMMAND(ID_FILE_RELOADCURRENT, &ThisClass::OnReloadCurrent)
	ON_COMMAND(ID_FILE_RELOADALL, &ThisClass::OnReloadAll)
	ON_COMMAND(ID_FILE_SAVECURRENT, &ThisClass::OnSaveCurrent)
	ON_COMMAND(ID_FILE_SAVEALL, &ThisClass::OnSaveAll)
	ON_COMMAND(ID_FILE_RELOADTEXTURES, &ThisClass::OnReloadTextures)


	ON_EN_KILLFOCUS(IDC_PSEd_CurrentParticleCap, &ThisClass::OnParticleCapEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleXMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleYMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleZMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleXMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleYMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleZMax, &ThisClass::OnParticleSystemEdit)

	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateXMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateYMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateZMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateXMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateYMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngularRateZMax, &ThisClass::OnParticleSystemEdit)

	ON_EN_KILLFOCUS(IDC_PSEd_AngleDampingMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_AngleDampingMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_VelocityDampingMin, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_VelocityDampingMax, &ThisClass::OnParticleSystemEdit)
	ON_EN_KILLFOCUS(IDC_PSEd_Gravity, &ThisClass::OnParticleSystemEdit)
END_MESSAGE_MAP()
