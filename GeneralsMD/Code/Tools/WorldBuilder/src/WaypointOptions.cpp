...
BEGIN_MESSAGE_MAP(WaypointOptions, COptionsPanel)
	...
	ON_CBN_KILLFOCUS(IDC_WAYPOINTNAME_EDIT, &ThisClass::OnChangeWaypointnameEdit)
	ON_CBN_KILLFOCUS(IDC_LIST_OF_WAYPOINT_NAMES, &ThisClass::OnChangeSelectedWaypoint)
	ON_EN_CHANGE(IDC_WAYPOINT_LOCATIONX, &ThisClass::OnEditWaypointLocationX)
	ON_EN_CHANGE(IDC_WAYPOINT_LOCATIONY, &ThisClass::OnEditWaypointLocationY)
	ON_EN_CHANGE(IDC_WAYPOINTLABEL1_EDIT, &ThisClass::OnEditchangeWaypointlabel1Edit)
	ON_EN_CHANGE(IDC_WAYPOINTLABEL2_EDIT, &ThisClass::OnEditchangeWaypointlabel2Edit)
	ON_EN_CHANGE(IDC_WAYPOINTLABEL3_EDIT, &ThisClass::OnEditchangeWaypointlabel3Edit)
	ON_CBN_SELENDOK(IDC_LIST_OF_WAYPOINT_NAMES, &ThisClass::OnChangeSelectedWaypoint)
	ON_CBN_SELENDOK(IDC_WAYPOINTNAME_EDIT, &ThisClass::OnChangeWaypointnameEdit)
	ON_BN_CLICKED(IDC_WAYPOINT_BIDIRECTIONAL, &ThisClass::OnWaypointBidirectional)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
