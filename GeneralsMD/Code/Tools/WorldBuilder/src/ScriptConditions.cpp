...
BEGIN_MESSAGE_MAP(ScriptConditionsDlg, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_EDIT_CONDITION, &ThisClass::OnEditCondition)
	ON_LBN_SELCHANGE(IDC_CONDITION_LIST, &ThisClass::OnSelchangeConditionList)
	ON_LBN_DBLCLK(IDC_CONDITION_LIST, &ThisClass::OnDblclkConditionList)
	ON_BN_CLICKED(IDC_OR, &ThisClass::OnOr)
	...
	ON_EN_CHANGE(IDC_EDIT_COMMENT, &ThisClass::OnChangeEditComment)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
