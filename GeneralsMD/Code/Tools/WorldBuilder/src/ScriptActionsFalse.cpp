...
BEGIN_MESSAGE_MAP(ScriptActionsFalse, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_EDIT, &ThisClass::OnEditAction)
	ON_LBN_SELCHANGE(IDC_ACTION_LIST, &ThisClass::OnSelchangeActionList)
	ON_LBN_DBLCLK(IDC_ACTION_LIST, &ThisClass::OnDblclkActionList)
