...
BEGIN_MESSAGE_MAP(GlobalLightOptions, CDialog)
	...
	ON_WM_SHOWWINDOW()
	ON_WM_CLOSE()
	ON_EN_CHANGE(IDC_RA_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_BA_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_GA_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_FB_EDIT, &ThisClass::OnChangeFrontBackEdit)
	ON_EN_CHANGE(IDC_FB_EDIT1, &ThisClass::OnChangeFrontBackEdit)
	ON_EN_CHANGE(IDC_FB_EDIT2, &ThisClass::OnChangeFrontBackEdit)
	ON_EN_CHANGE(IDC_LR_EDIT, &ThisClass::OnChangeLeftRightEdit)
	ON_EN_CHANGE(IDC_LR_EDIT1, &ThisClass::OnChangeLeftRightEdit)
	ON_EN_CHANGE(IDC_LR_EDIT2, &ThisClass::OnChangeLeftRightEdit)
	ON_EN_CHANGE(IDC_RD_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_GD_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_BD_EDIT, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_RD_EDIT1, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_GD_EDIT1, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_BD_EDIT1, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_RD_EDIT2, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_GD_EDIT2, &ThisClass::OnChangeColorEdit)
	ON_EN_CHANGE(IDC_BD_EDIT2, &ThisClass::OnChangeColorEdit)
	ON_BN_CLICKED(IDC_RADIO_EVERYTHING, &ThisClass::OnRadioEverything)
	ON_BN_CLICKED(IDC_RADIO_OBJECTS, &ThisClass::OnRadioObjects)
	ON_BN_CLICKED(IDC_RADIO_TERRAIN, &ThisClass::OnRadioTerrain)
	ON_BN_CLICKED(IDC_PSEd_Color1, &ThisClass::OnColorPress)
	ON_BN_CLICKED(IDC_GlobalLightingReset, &ThisClass::OnResetLights)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
