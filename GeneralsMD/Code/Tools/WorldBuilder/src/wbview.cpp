...
BEGIN_MESSAGE_MAP(WbView, CView)
	...
	ON_COMMAND(ID_EDIT_COPY, &ThisClass::OnEditCopy)
	ON_UPDATE_COMMAND_UI(ID_EDIT_COPY, &ThisClass::OnUpdateEditCopy)
	ON_COMMAND(ID_EDIT_CUT, &ThisClass::OnEditCut)
	ON_UPDATE_COMMAND_UI(ID_EDIT_CUT, &ThisClass::OnUpdateEditCut)
	ON_COMMAND(ID_EDIT_PASTE, &ThisClass::OnEditPaste)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PASTE, &ThisClass::OnUpdateEditPaste)
	ON_COMMAND(ID_VIEW_SNAPTOGRID, &ThisClass::OnViewSnaptogrid)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SNAPTOGRID, &ThisClass::OnUpdateViewSnaptogrid)
	ON_COMMAND(ID_VIEW_SHOW_OBJECTS, &ThisClass::OnViewShowObjects)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOW_OBJECTS, &ThisClass::OnUpdateViewShowObjects)
	ON_COMMAND(ID_EDIT_SELECTDUP, &ThisClass::OnEditSelectdup)
	ON_COMMAND(ID_EDIT_SELECTSIMILAR, &ThisClass::OnEditSelectsimilar)
	ON_COMMAND(ID_EDIT_REPLACE, &ThisClass::OnEditReplace)
	ON_COMMAND(ID_EDIT_SELECTINVALIDTEAM, &ThisClass::OnEditSelectinvalidteam)
	ON_COMMAND(ID_OBJECTPROPERTIES_REFLECTSINMIRROR, &ThisClass::OnObjectpropertiesReflectsinmirror)
	ON_COMMAND(ID_LOCK_HORIZONTAL, &ThisClass::OnLockHorizontal)
	ON_UPDATE_COMMAND_UI(ID_LOCK_HORIZONTAL, &ThisClass::OnUpdateLockHorizontal)
	ON_COMMAND(ID_EDIT_GLOBALLIGHTOPTIONS, &ThisClass::OnEditGloballightoptions)
	ON_COMMAND(ID_VIEW_SHOWWAYPOINTS, &ThisClass::OnViewShowwaypoints)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWWAYPOINTS, &ThisClass::OnUpdateViewShowwaypoints)
	ON_COMMAND(ID_VIEW_SHOWPOLYGONTRIGGERS, &ThisClass::OnViewShowpolygontriggers)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWPOLYGONTRIGGERS, &ThisClass::OnUpdateViewShowpolygontriggers)
	ON_COMMAND(ID_EDIT_PLAYERLIST, &ThisClass::OnEditPlayerlist)
	ON_COMMAND(ID_EDIT_WORLDINFO, &ThisClass::OnEditWorldinfo)
	ON_COMMAND(ID_EDIT_TEAMLIST, &ThisClass::OnEditTeamlist)
	ON_COMMAND(ID_TEAM_EDIT, &ThisClass::OnEditTeamlist)
	ON_UPDATE_COMMAND_UI(ID_OBJECTPROPERTIES_REFLECTSINMIRROR, &ThisClass::OnUpdateObjectpropertiesReflectsinmirror)
	ON_COMMAND(ID_EDIT_PICKSTRUCTS, &ThisClass::OnPickStructures)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKSTRUCTS, &ThisClass::OnUpdatePickStructures)
	ON_COMMAND(ID_EDIT_PICKINFANTRY, &ThisClass::OnPickInfantry)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKINFANTRY, &ThisClass::OnUpdatePickInfantry)
	ON_COMMAND(ID_EDIT_PICKVEHICLES, &ThisClass::OnPickVehicles)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKVEHICLES, &ThisClass::OnUpdatePickVehicles)
	ON_COMMAND(ID_EDIT_PICKSHRUBBERY, &ThisClass::OnPickShrubbery)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKSHRUBBERY, &ThisClass::OnUpdatePickShrubbery)
	ON_COMMAND(ID_EDIT_PICKMANMADE, &ThisClass::OnPickManMade)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKMANMADE, &ThisClass::OnUpdatePickManMade)
	ON_COMMAND(ID_EDIT_PICKNATURAL, &ThisClass::OnPickNatural)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKNATURAL, &ThisClass::OnUpdatePickNatural)
	ON_COMMAND(ID_EDIT_PICKDEBRIS, &ThisClass::OnPickDebris)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKDEBRIS, &ThisClass::OnUpdatePickDebris)
	ON_COMMAND(ID_EDIT_PICKANYTHING, &ThisClass::OnPickAnything)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKANYTHING, &ThisClass::OnUpdatePickAnything)
	ON_COMMAND(ID_EDIT_PICKWAYPOINTS, &ThisClass::OnPickWaypoints)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKWAYPOINTS, &ThisClass::OnUpdatePickWaypoints)
	ON_COMMAND(ID_EDIT_PICKROADS, &ThisClass::OnPickRoads)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKROADS, &ThisClass::OnUpdatePickRoads)
	ON_COMMAND(ID_EDIT_PICKSOUNDS, &ThisClass::OnPickSounds)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PICKSOUNDS, &ThisClass::OnUpdatePickSounds)
	ON_COMMAND(ID_VIEW_LABELS, &ThisClass::OnShowNames)
	ON_UPDATE_COMMAND_UI(ID_VIEW_LABELS, &ThisClass::OnUpdateShowNames)
	ON_COMMAND(ID_VALIDATION_FIXTEAMS, &ThisClass::OnValidationFixTeams)
	ON_COMMAND(ID_VIEW_SHOW_TERRAIN, &ThisClass::OnShowTerrain)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOW_TERRAIN, &ThisClass::OnUpdateShowTerrain)
	ON_WM_CREATE()
