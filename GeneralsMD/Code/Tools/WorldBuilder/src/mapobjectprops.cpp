...
BEGIN_MESSAGE_MAP(MapObjectProps, CDialog)
	...
	ON_BN_CLICKED(IDC_CUSTOMIZE_CHECKBOX, &ThisClass::customizeToDict)
	ON_BN_CLICKED(IDC_EDITPROP, &ThisClass::OnEditprop)
	ON_BN_CLICKED(IDC_ENABLED_CHECKBOX, &ThisClass::enabledToDict)
	ON_BN_CLICKED(IDC_LOOPING_CHECKBOX, &ThisClass::loopingToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Enabled, &ThisClass::_EnabledToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Indestructible, &ThisClass::_IndestructibleToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Powered, &ThisClass::_PoweredToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_RecruitableAI, &ThisClass::_RecruitableAIToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Selectable, &ThisClass::_SelectableToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Targetable, &ThisClass::_TargetableToDict)
	ON_BN_CLICKED(IDC_MAPOBJECT_Unsellable, &ThisClass::_UnsellableToDict)
	ON_BN_CLICKED(IDC_NEWPROP, &ThisClass::OnNewprop)
	ON_BN_CLICKED(IDC_REMOVEPROP, &ThisClass::OnRemoveprop)
	ON_BN_CLICKED(IDC_SCALE_OFF, &ThisClass::OnScaleOff)
	ON_BN_CLICKED(IDC_SCALE_ON, &ThisClass::OnScaleOn)
	ON_CBN_KILLFOCUS(IDC_MAPOBJECT_HitPoints, &ThisClass::_HPsToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Aggressiveness, &ThisClass::_AggressivenessToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Script, &ThisClass::_ScriptToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_StartingHealth, &ThisClass::_HealthToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Team, &ThisClass::_TeamToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Time, &ThisClass::_TimeToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Veterancy, &ThisClass::_VeterancyToDict)
	ON_CBN_SELCHANGE(IDC_MAPOBJECT_Weather, &ThisClass::_WeatherToDict)
	ON_CBN_SELCHANGE(IDC_PRIORITY_COMBO, &ThisClass::priorityToDict)
	ON_CBN_SELCHANGE(IDC_SOUND_COMBO, &ThisClass::attachedSoundToDict)
	ON_CBN_SELENDOK(IDC_MAPOBJECT_HitPoints, &ThisClass::_HPsToDict)
	ON_EN_KILLFOCUS(IDC_LOOPCOUNT_EDIT, &ThisClass::loopCountToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_Angle, &ThisClass::SetAngle)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_Name, &ThisClass::_NameToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_Scale, &ThisClass::_ScaleToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_ShroudClearingDistance, &ThisClass::_ShroudClearingDistanceToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_StartingHealthEdit, &ThisClass::_HealthToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_StoppingDistance, &ThisClass::_StoppingDistanceToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_VisionDistance, &ThisClass::_VisibilityToDict)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_XYPosition, &ThisClass::OnKillfocusMAPOBJECTXYPosition)
	ON_EN_KILLFOCUS(IDC_MAPOBJECT_ZOffset, &ThisClass::SetZOffset)
	ON_EN_KILLFOCUS(IDC_MAX_RANGE_EDIT, &ThisClass::maxRangeToDict)
	ON_EN_KILLFOCUS(IDC_MIN_RANGE_EDIT, &ThisClass::minRangeToDict)
	ON_EN_KILLFOCUS(IDC_MIN_VOLUME_EDIT, &ThisClass::minVolumeToDict)
	ON_EN_KILLFOCUS(IDC_VOLUME_EDIT, &ThisClass::volumeToDict)
	ON_LBN_DBLCLK(IDC_PROPERTIES, &ThisClass::OnDblclkProperties)
	ON_LBN_SELCHANGE(IDC_MAPOBJECT_BuildWithUpgrades, &ThisClass::_PrebuiltUpgradesToDict)
	ON_LBN_SELCHANGE(IDC_PROPERTIES, &ThisClass::OnSelchangeProperties)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
