...
BEGIN_MESSAGE_MAP(GroveOptions, CDialog)
	ON_EN_KILLFOCUS(IDC_Grove_Per1, &ThisClass::_updateTreeWeights)
	ON_EN_KILLFOCUS(IDC_Grove_Per2, &ThisClass::_updateTreeWeights)
	ON_EN_KILLFOCUS(IDC_Grove_Per3, &ThisClass::_updateTreeWeights)
	ON_EN_KILLFOCUS(IDC_Grove_Per4, &ThisClass::_updateTreeWeights)
	ON_EN_KILLFOCUS(IDC_Grove_Per5, &ThisClass::_updateTreeWeights)
	ON_EN_KILLFOCUS(IDC_Grove_NumberTrees, &ThisClass::_updateTreeCount)
	ON_CBN_SELENDOK(IDC_Grove_Type1, &ThisClass::_updateGroveMakeup)
	ON_CBN_SELENDOK(IDC_Grove_Type2, &ThisClass::_updateGroveMakeup)
	ON_CBN_SELENDOK(IDC_Grove_Type3, &ThisClass::_updateGroveMakeup)
	ON_CBN_SELENDOK(IDC_Grove_Type4, &ThisClass::_updateGroveMakeup)
	ON_CBN_SELENDOK(IDC_Grove_Type5, &ThisClass::_updateGroveMakeup)
	ON_BN_CLICKED(IDC_Grove_AllowCliffPlacement, &ThisClass::_updatePlacementAllowed)
	ON_BN_CLICKED(IDC_Grove_AllowWaterPlacement, &ThisClass::_updatePlacementAllowed)
END_MESSAGE_MAP()